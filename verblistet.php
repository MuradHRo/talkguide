...
if(isset($_GET["sendWord"])){
    ...
    if(empty($_GET["word"])){
        ...
        $sendWordObj = new addWords($connection,"verb");
...
<body>
    ...
    <nav class = "myNav navbar navbar-expand-lg navbar-light">
        <a class="navbar-brand" href = 'index'><img src="assets/imgs/logo.png" alt="flags-logo" width="312" class="animated fadeIn"></a>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="verblistet" style="border-bottom: 7px solid #fff;" class="nav-link">Verblister</a></li>
        ...
        <div class="content">
            ...
            <div class="searchBox-verb">
                    ...
                    <tbody id="results-body">
                        <?php
                        $listObj = new dataFetch($connection,"verb",$limit,$page);
                        $listObj->getData();
                        ?>
	            	</tbody>
                    </table>
    ...
    <footer>
        ...
        <p>Designed by:<a href="https://www.peofree.com/" target="_blank"> PeoFree </a></p>
